...
public class Application {
    ...
    private static void selectBuilderSubMenu() {
        Scanner sc = new Scanner(System.in);
        SelectBiulderService selectBiulderService = new SelectBiulderService();
        do {
            ...
            switch (no) {
                case 1 : selectBiulderService.testSimpleStatement(); break;
                case 2 : selectBiulderService.testDynamicStatement(inputSearchCriteria()); break;
                case 9 : return;
            }
